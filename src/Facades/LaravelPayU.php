...
/**
 * Class LaravelPayU
 * @package FuriosoJack\PayUPaymentLaravel\Facades
...
class LaravelPayU
{
    ...
    public static function getAccountId()
    {
        ...
        return Config::get('payu_payment.payu_account_id');
    }
    /**
     * Get the Merchant ID.
     *
    ...
    public static function getMerchantId()
    {
        ...
        return Config::get('payu_payment.payu_merchant_id');
    }
    /**
     * Get the API login.
     *
    ...
    public static function getApiLogin()
    {
        ...
        return Config::get('payu_payment.payu_api_login');
    }
    /**
     * Get the API key.
     *
    ...
    public static function getApiKey()
    {
        ...
        return Config::get('payu_payment.payu_api_key');
    }
    /**
    ...
    public static function getCountry()
    {
        ...
        return Config::get('payu_payment.payu_country');
    }
    /**
    ...
    public static function getRedirectPSE()
    {
        ...
        return Config::get('payu_payment.pse_redirect_url');
    }
    /**
    ...
    private static function isAccountInTesting()
    {
        ...
        return Config::get('payu_payment.payu_testing');
    }
    /**
